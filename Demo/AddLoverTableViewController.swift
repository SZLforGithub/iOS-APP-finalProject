...
class AddLoverTableViewController: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func done(_ sender: Any) {
        ...
        print("\(categoryTextField.text!) \(introductionTextField.text!)")
        
        if categoryTextField.text!.characters.count  == 0 || introductionTextField.text!.characters.count == 0 {
        ...
        let url = docUrl?.appendingPathComponent("\(categoryTextField.text!).png")
        ...
        let dic = ["category":categoryTextField.text!,
