//
//  AddImpressionTableViewController.swift
//  Demo
//
...
class AddImpressionTableViewController: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func done(_ sender: Any) {
        ...
        print("\(nameTextField.text!) \(dateTextField.text!)")
        
        if nameTextField.text!.characters.count  == 0 || dateTextField.text!.characters.count == 0 || categoryTextField.text!.characters.count == 0  {
        ...
        let dic = ["name":nameTextField.text!,
                   ...
                   "impression":impressionTextView.text!]
